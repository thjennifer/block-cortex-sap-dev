####!!!!! TODO: TEST WHEN LOCALE IS NOT SET OR RETURNS NO ROWS
...
#    - for this example, user_attribute = 'es_ES'
#   - read user_attribute value
...
#
#  use this view as inner join to materials_MD and others which require language_key_spras
######################
