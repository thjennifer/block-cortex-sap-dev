- dashboard: backup_order_status
  ...
  - name: Order Status
    ...
    fields: [across_sales_and_billing_summary_xvw.order_status, sales_orders_v2.sales_order_count_formatted, across_sales_and_billing_summary_xvw.max_order_status]
    ...
    #         id: Open - sales_orders_v2.sales_order_count, name: Open, __FILE: block-revamp-sap-dev/dashboards/otc_03_order_details.dashboard.lookml,
    #         __LINE_NUM: 116}, {axisId: Closed - sales_orders_v2.sales_order_count, id: Closed
    #           - sales_orders_v2.sales_order_count, name: Closed, __FILE: block-revamp-sap-dev/dashboards/otc_03_order_details.dashboard.lookml,
    #         __LINE_NUM: 117}, {axisId: Cancelled - sales_orders_v2.sales_order_count, id: Cancelled
    #           - sales_orders_v2.sales_order_count, name: Cancelled, __FILE: block-revamp-sap-dev/dashboards/otc_03_order_details.dashboard.lookml,
    ...
    #     __LINE_NUM: 116}]
    y_axes: [{label: '', orientation: bottom, series: [{axisId: Open - sales_orders_v2.sales_order_count_formatted,
            id: Open - sales_orders_v2.sales_order_count_formatted, name: Open, }, {axisId: Closed - sales_orders_v2.count_orders, id: Closed
              - sales_orders_v2.sales_order_count_formatted, name: Closed, }, {axisId: Cancelled - sales_orders_v2.sales_order_count_formatted, id: Cancelled
              - sales_orders_v2.sales_order_count_formatted, name: Cancelled, }], showLabels: false, showValues: false, unpinAxis: false,
    ...
    series_colors:
      Open - sales_orders_v2.sales_order_count_formatted: "#98B6B1"
      Closed - sales_orders_v2.sales_order_count_formatted: "#BFBDC1"
      Cancelled - sales_orders_v2.sales_order_count_formatted: "#Eb9486"
    advanced_vis_config: |-
      {
        plotOptions: {
          series: {
