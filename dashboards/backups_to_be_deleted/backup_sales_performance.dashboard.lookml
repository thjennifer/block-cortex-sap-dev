- dashboard: backup_sales_performance
  ...
  - name: Top Products by Sales
    ...
    type: looker_bar
    fields: [materials_md.material_number_matnr, materials_md.material_text_maktx, sales_orders_v2.total_sales_amount_target_currency_formatted]
  ...
  - name: Top Sales Organizations by Sales
    ...
    explore: sales_orders_v2
    type: looker_bar
    fields: [sales_orders_v2.sales_organization_vkorg,sales_organizations_md.sales_org_name_vtext,sales_orders_v2.total_sales_amount_target_currency_formatted]
    sorts: [sales_orders_v2.total_sales_amount_target_currency_formatted desc]
    limit: 10
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    y_axes: [{label: '', orientation: bottom, series: [{axisId: sales_orders_v2.total_sales_amount_target_currency_formatted,
            id: sales_orders_v2.total_sales_amount_target_currency_formatted, name: Total
  ...
  - name: Sales by Distribution Channel
    ...
    explore: sales_orders_v2
    type: looker_pie
    fields: [sales_orders_v2.total_sales_amount_target_currency_formatted, sales_orders_v2.distribution_channel_vtweg,
    ...
    totals_color: "#808080"
    # y_axes: [{label: '', orientation: bottom, series: [{axisId: sales_orders_v2.total_sales_amount_target_currency_formatted,
    #         id: sales_orders_v2.total_sales_amount_target_currency_formatted, __FILE: block-revamp-sap-dev/dashboards/otc_03_sales_performance.dashboard.lookml,
    ...
    # type: looker_bar
    # fields: [sales_orders_v2.total_sales_amount_target_currency_formatted, sales_orders_v2.distribution_channel_vtweg,
    #   distribution_channels_md.distribution_channel_name_vtext, sales_orders_v2.percent_of_total_sales_amount_target_currency]
    # sorts: [sales_orders_v2.total_sales_amount_target_currency_formatted desc 0]
    # x_axis_gridlines: false
    # y_axis_gridlines: true
    # show_view_names: false
    ...
    # totals_color: "#808080"
    # y_axes: [{label: '', orientation: bottom, series: [{axisId: sales_orders_v2.total_sales_amount_target_currency_formatted,
    #         id: sales_orders_v2.total_sales_amount_target_currency_formatted}], showLabels: true, showValues: false, unpinAxis: false,
  ...
  - name: Sales by Division
    ...
    explore: sales_orders_v2
    type: looker_bar
    fields: [sales_orders_v2.total_sales_amount_target_currency_formatted, sales_orders_v2.division_hdr_spart, divisions_md.division_name_vtext, sales_orders_v2.percent_of_total_sales_amount_target_currency]
    sorts: [sales_orders_v2.total_sales_amount_target_currency_formatted desc 0]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
